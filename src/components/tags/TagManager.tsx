...
export default function TagManager({ title, projectId, tags, onTagsChange, initialTags }: TagManagerProps) {
  ...
  }, [backendEnabled, normalizedProjectId, persistLocalTags]);
