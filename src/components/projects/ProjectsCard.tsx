                ...
                {isRenaming ? (
                  <div className="flex flex-col gap-2 w-full">
                    <input
                      ...
                      className="text-lg font-medium text-gray-900 dark:text-white bg-transparent border-b border-gray-400 focus:outline-none"
                      autoFocus
                    ...
                    <textarea
                      ...
                      className="text-sm text-gray-800 dark:text-gray-100 bg-transparent border border-gray-300 dark:border-gray-700 rounded-md p-2"
                      rows={3}
                    />
                    {errorMessage && (
                    ...
                    <div className="flex gap-2 mt-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1 bg-gray-300 dark:bg-gray-700 text-gray-900 dark:text-white rounded-md hover:bg-gray-400 dark:hover:bg-gray-600 transition"
                      >
                        Cancel
                      </button>
                    </div>
