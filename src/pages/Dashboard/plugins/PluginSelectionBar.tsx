  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-2">
        <label className="inline-flex items-center gap-2 rounded-xl border border-gray-300/80 bg-white px-3 py-2 text-xs text-gray-700 shadow-sm dark:border-gray-700 dark:bg-slate-900 dark:text-gray-200">
          <input
            type="checkbox"
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl border border-gray-300 bg-white px-4 py-2 text-sm  text-gray-800 shadow-sm transition hover:border-gray-400 hover:shadow-md disabled:cursor-not-allowed disabled:opacity-60 dark:border-gray-700 dark:bg-slate-900 dark:text-white"
        >
          <X className="h-4 w-4" />
          Clear
        </button>
