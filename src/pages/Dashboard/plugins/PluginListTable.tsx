...
const listGridClassName = "grid grid-cols-[44px_minmax(280px,1.6fr)_minmax(140px,0.8fr)_minmax(150px,0.8fr)_minmax(120px,0.7fr)_minmax(160px,1fr)_96px] gap-3";
